...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        if isinstance(c, carla.VehicleControl):
            ...
            temp_list += [
                (c.throttle),(c.steer),(c.brake),(c.reverse),(c.hand_brake),(c.manual_gear_shift)
            ]
            with open ('Driving_record.csv', 'a', encoding='UTF-8', newline='') as f:
            ...
            '''
            with open('Driving_record.txt','a',encoding='UTF-8') as f:
                for value in self._info_text:
                    f.write(str(value))
                    f.write('\n')
            f.close
            '''
